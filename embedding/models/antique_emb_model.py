...
from utils_functions.string_manager import antique_embedding_model_path, antique_embedding_vector_db_path


class AntiqueEmbModel:
    ...
    def __init__(
        ...
        self.model_storage_path: str = antique_embedding_model_path
        self.vector_db_instance = VectorDBHelper.get_instance(db_path=antique_embedding_vector_db_path)
        self.dataset = DatasetLoader.load_antique_from_file(dataset_path)
        self.text_processor = text_processor
        # self.dataset = DatasetLoader().load_antique()  # TODO: ACTIVATE IT..
